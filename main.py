...
from utils.utils import check_best_models
from utils.utils import delete_not_best_models
...
def check_curr_best_models_save_and_delete(model,modelName,modelPath):
    ...
    best_model_dict = check_best_models()
...
def main():
    ...
    if args.train_ft :
        ...
        if ((args.corpusName is not None) and (args.ft_window is not None) and (args.ft_size is not None) and (args.ft_sg is not None) and (args.ft_epochs is not None) and (args.ft_min_count is not None)):
